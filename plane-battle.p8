...
function check_collision(pl, flame_spr, flame)
  for actor in all(actors) do
		if (actor.spr == laser_spr or actor.spr == bullet_spr_horiz or actor.spr == bullet_spr_vert or actor.spr == mortar_spr or actor.spr == explosion_spr or is_exploding_spr(actor.spr) or actor.spr == bomb_ww1_spr or actor.spr == bomb_ww2_spr) then
      if (actor.x >  pl.x -.7  
        and actor.x < pl.x +.7  
        and actor.y > pl.y - .7  
        ...
        if (not is_crashing) then
          ...
          switch(pl) 	
          if (pl.damage == game_over_damage or actor.spr == laser_spr or actor.spr == explosion_spr or is_exploding_spr(actor.spr)) then
...
00050500000050000003030000003000080505080008580008030308000838000008000000000000000000007777777700777700000000000000000000000000
...

